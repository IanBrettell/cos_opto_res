...
snakemake <- Snakemake(
    input = list('/hps/research1/birney/users/ian/opto_res/videos/20210203/pass_2/results/raw/20210226_6_4dpi1dpi_cabcr5inj2_W50_sp1_op80_LGG_MMStack_Default_CSV-Table.csv.csv'),
    output = list('data/tracking/20210203/pass_2/20210226_6_4dpi1dpi_cabcr5inj2_W50_sp1_op80_LGG_MMStack_Default.csv'),
    params = list(),
    wildcards = list('20210226_6_4dpi1dpi_cabcr5inj2_W50_sp1_op80_LGG_MMStack_Default', "sample" = '20210226_6_4dpi1dpi_cabcr5inj2_W50_sp1_op80_LGG_MMStack_Default'),
    threads = 1,
    log = list(),
    resources = list(),
