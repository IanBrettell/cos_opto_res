...
snakemake <- Snakemake(
    input = list('/hps/research1/birney/users/ian/opto_res/videos/20210203/tifs/20210301_4_7dpi4dpi_cabcr5inj2_W50_sp0.6_op50_GW_MMStack_Default.ome.tif'),
    output = list('plots/20210203/lane_demarcations/20210301_4_7dpi4dpi_cabcr5inj2_W50_sp0.6_op50_GW_MMStack_Default.png'),
    params = list('code/snakemake/20210203/config/samples.csv', '20210301_4_7dpi4dpi_cabcr5inj2_W50_sp0.6_op50_GW_MMStack_Default', "samples_file" = 'code/snakemake/20210203/config/samples.csv', "sample_name" = '20210301_4_7dpi4dpi_cabcr5inj2_W50_sp0.6_op50_GW_MMStack_Default'),
    wildcards = list('20210301_4_7dpi4dpi_cabcr5inj2_W50_sp0.6_op50_GW_MMStack_Default', "sample" = '20210301_4_7dpi4dpi_cabcr5inj2_W50_sp0.6_op50_GW_MMStack_Default'),
    threads = 1,
    log = list(),
    resources = list(),
