...
lapply(unique(samples_df$SAMPLE, function(SAMPLE)){
  
  sample_video = file.path(video_dir, paste(SAMPLE, ".ome.tif", sep = ""))
...
```{r, eval = F}
################################################## To adapt
path_to_samples_file="{path_to_samples_file}"
sample_name="{name_of_sample_to_analyse}"
...
convert_tif2h5_script={path_to_tif2h5_script}
fiji={path_to_fiji}
